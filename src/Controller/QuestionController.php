...
class QuestionController extends AbstractController
{
  ...
  /**
     * @Route("/new/{id_cours<[0-9]+>}/question/new", name="question_new", methods={"GET"})
     * @Entity("cours", expr="repository.find(id_cours)")
     * @Security("is_granted('ROLE_ENSEIGNANT') and cours.getEnseignant() == user", statusCode=401, message="Accès non autorisé")
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $question->setEnseignant($this->getUser());
