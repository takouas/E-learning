...
class FormationController extends AbstractController
{
    ...
    /**
     * @Route("/admin/formations", name="admin_formation_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/admin/formations/creer", name="admin_formation_creer", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/admin/formations/{id<[0-9]+>}/editer", name="admin_formationn_editer")
     */
    public function modifier(Formation $formation, Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('admin/formation/editer.html.twig', [
            'formation' => $formation,
            'formFormation' => $form->createView()
        ]);
    }
    ...
    /**
     * @Route("/admin/formations/{id<[0-9]+>}/supprimer", name="admin_formation_supprimer")
     */
